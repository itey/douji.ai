const abi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_priceAsset", type: "address" },
    ],
    name: "getTokenPrice",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "enum BJXStar1155.Role", name: "_role", type: "uint8" },
    ],
    name: "grant",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_tokenId", type: "uint256" },
      { internalType: "uint256", name: "_availableSupply", type: "uint256" },
    ],
    name: "setAvailableSupply",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
