<template>
	<div>
		<div class="navbar-container">
			<img @click="$router.push('/profile')" style="width: 120px; height: 27px;cursor: pointer;"
				src="@/assets/logo.png" />
			<div class="navbar-divider"></div>
			<div class="navbar-menu">
				<div class="navbar-menu-item text-color" @click="$router.push('/')">{{$t('common.home')}}</div>
				<div class="navbar-menu-item text-color" @mouseover="menuToggle(true)" @mouseout="menuToggle(false)"
					@click="$router.push('/news')">
					{{$t('common.news')}}
				</div>
				<div class="navbar-menu-item text-color" @click="toNavigation()">{{$t('common.navigation')}}</div>
				<div class="navbar-menu-item text-color" @click="$router.push('/market')">{{$t('common.marketplace')}}
				</div>
			...
			<div class="navbar-language" @click="languageVisible = true">
				<el-popover placement="bottom" width="79px" height="79px" :visible-arrow="false"
		...
		<div class="news-types-container" v-if="menuSubVisible" @mouseover="menuToggle(true)"
