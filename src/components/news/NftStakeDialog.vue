<template>
	<el-dialog custom-class="nft-stake-dialog" :visible.sync="show" width="1440px">
		<div class="nft-stake-header text-color" slot="title">
			NFT Stake Income settlement
		</div>
		<div class="nft-stake-content">
			<div class="nft-stake-container">
				<div class="nft-stake-top">
					<div class="nft-stake-left">
						<div class="nft-stake-title text-color">
							Enterprise Metaverse Users Prefer Simplifed Digital Avatars Ove
						</div>
						<img style="width: 939px;height: 532px;margin-top:50px;" />
						<div class="nft-stake-desc text-color">
							The easy-to-use prompt to generate the portrait photography wit
						</div>
						...
						<div class="nft-stake-tag">
							...
							<div class="nft-stake-tag-item text-color" v-for="(item,index) in 4" :key="index">
								NFT
							</div>
						</div>
					</div>
					<div class="nft-stake-right">
						...
						<div class="nft-stake-attr-container">
							...
							<div class="nft-stake-dao">
								...
								<div class="dao-title text-color" style="margin-top: 26px;margin-bottom:3px">NFT DAO
									Income Distribution</div>
								...
								<div class="dao-title text-color" style="margin-top: 28px;">NFT Staker Bonus Dividend
									Pool</div>
