	...
	<div class="create-step2">
		...
		<div class="form-container">
			...
			<div class="form-item">
				...
				<div class="form-value">
					<div>
						<el-upload :limit="1" class="form-upload" :on-change="fileChange" :auto-upload="false"
							:action="upload.action" :headers="upload.headers">
							<div slot="default">
			...
			<div class="form-item">
				...
				<div class="form-value">
					<div style="width: 544px;">
						<el-input class="input" type="textarea" v-model="markContent" @input="updateMark"
							rows="10"></el-input>
