	...
	<div class="create-step2">
		...
		<div class="form-container">
			...
			<div class="form-item">
				...
				<div class="form-value">
					<div>
						<el-input class="input" type="textarea" rows="3"></el-input>
					</div>
					<div class="tip">
						Write some details about your content
					</div>
				</div>
			</div>
			<div class="form-item">
			...
			<div class="form-item">
				...
				<div class="form-value">
					...
					<div class="tip">
						Write some keywords about your content
					</div>
				</div>
			</div>
			<div class="form-item">
