		...
		<div class="form-container">
			<div class="form-item">
				...
				<div class="form-value">
					<div>
						<el-input v-model="form.title" @change="checkItem('title')" class="input"
			...
			<div class="form-item">
				...
				<div class="form-value">
					<div>
						<el-input v-model="form.description" @change="checkItem('description')" class="input"
							type="textarea" rows="3" maxlength="300"></el-input>
					</div>
			...
			<div class="form-item">
				...
				<div class="form-value">
					<el-upload accept=".png, .jpeg, .jpg, .gif" :show-file-list="false" class="form-upload"
						:on-change="fileChange" :auto-upload="false" action="#">
			...
			<div class="form-item">
				...
				<div class="form-value">
					<div>
						<el-tag class="tag" :key="tag" v-for="tag in tags" closable :disable-transitions="false"
