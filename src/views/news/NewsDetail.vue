<template>
  <div class="news-container">
    <el-breadcrumb style="margin-top: 27px;" separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>
        Users Prefer Simplifed Digital Avatars Over Hyper-Realistic
        Alternatives
      </el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <div class="form-container">
      <div class="form-top">
        <div class="form-left">
          ...
          <div class="form-desc">
            The easy-to-use prompt to generate the portrait photography with sea activity
          ...
          <div style="display: flex;flex-direction: column;align-items: center;">
            <div class="text-color" style="font-size: 12px;">
              ...
              <span style="color: #00F9E5;">Token ID: 2</span>) And Clicking
              “
          ...
          <div class="form-tag">
            ...
            <div class="form-tag-item text-color" v-for="(item,index) in 5" :key="index">NFT</div>
          </div>
          ...
          <div class="form-attr-container">
            ...
            <div class="form-attr-list">
              ...
              <div class="form-attr-item">
                ...
                <div class="form-attr-value">50</div>
              </div>
              <div class="form-attr-item">
              ...
              <div class="form-attr-item">
                ...
                <div class="form-attr-value">250</div>
              </div>
            </div>
          </div>
          <div class="form-attr-container">
            ...
            <div class="form-attr-market">
              ...
              <div class="form-attr-mbd">
                <div class="mbd-value text-color">100 MBD</div>
                <div class="mbd-transform">≈$626 57</div>
              </div>
              <el-button :disabled="true" class="common-btn2 form-attr-mint">Mint</el-button>
...
import { tokensData } from '@/utils/web3/nft'
export default {
