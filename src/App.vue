...
const config: ConnectConfig = {
    projectId: import.meta.env.VITE_P_PROJECT_ID,
    clientKey: import.meta.env.VITE_P_PROJECT_KEY,
    appId: import.meta.env.VITE_P_APP_ID,
    chains: [Ethereum as Chain, EthereumGoerli as Chain],
    wallets: [
        metaMask({ projectId: import.meta.env.VITE_P_WALLETE_ID, showQrModal: false }),
        walletconnect({ projectId: import.meta.env.VITE_P_WALLETE_ID, showQrModal: true }),
    ],
};
